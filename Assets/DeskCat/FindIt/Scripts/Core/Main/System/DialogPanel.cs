...
namespace DeskCat.FindIt.Scripts.Core.Main.System
{
    public class DialogPanel : MonoBehaviour
    {
        ...
        public List<MultiDialogTextListModel> DialogContent = new List<MultiDialogTextListModel>();

        private Dictionary<string, List<DialogListModel>> DialogContentDic = new Dictionary<string, List<DialogListModel>>();
        ...
        private void BuildDictionary()
        {
            ...
            {
                DialogContentDic[dialogModel.LanguageKey]= dialogModel.Value;
            }
        }
    }
}