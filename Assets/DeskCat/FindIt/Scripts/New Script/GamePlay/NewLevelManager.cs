...
namespace DeskCat.FindIt.Scripts.Core.Main.System
{
    public class NewLevelManager : MonoBehaviour
    {
        ...
        public HiddenObjScrollBar HorizontalScrollView;
        public HiddenObjScrollBar VerticalScrollView;
        private HiddenObjScrollBar CurrentScrollView;
        ...
        private static NewLevelManager LevelManagerInstance;
        ...
        private void BuildDictionary()
        {
            ...
            for (var i = 0; i < TargetObjDic.Count - MaxRandomItem; i++)
            {
                ...
                randomIndex.Add(Random.Range(0, TargetObjDic.Count - 1));
            }

            foreach (var index in randomIndex)
            {
                TargetObjDic.Remove(TargetObjDic.ElementAt(index).Key);
            }
        }
